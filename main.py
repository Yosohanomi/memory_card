...
class Question():
    ...
    def got_wrong(self):
        self.count_asked += 1
q1 = Question("яблуко", "apple", "pineaple", "apply", "application")
q2 = Question("ананас", "pineaple", "aplepine", "pencil", "pan")
q3 = Question("хмара", "cloud", "clock", "common", "fluffy")
q4 = Question("листя", "leaf", "leave", "live", "alive")
...
def add_question():
    new_q = Question(le_question.text(), le_right_ans.text(), le_wrong1_ans.text(), le_wrong2_ans.text(), le_wrong3_ans.text())
